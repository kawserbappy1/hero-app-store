...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center bg-titleColor text-base-content rounded p-10">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ...
                    : "font-[600] leading-[24.32px] text-white hover:text-[#632EE3]"
                }
              >
                Home
              </NavLink>
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://github.com/kawserbappy1">
            <svg
